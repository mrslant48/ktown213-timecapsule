...
<title>ktown213.com - Login</title><SCRIPT LANGUAGE="JavaScript">
<!--
  function squirrelmail_loginpage_onload() {
    document.forms[0].js_autodetect_results.value = '1';
    document.forms[0].elements[0].focus();
  }
  self.regSMEmail = /^[a-zA-Z0-9\-\.\_]+\@ktown213.com$/;
  function checkForm(form) {
    ...
    if ((checkusername == null) || (checkusername[0] != username)) {
      alert("You must enter your fully qualified email address, such as username@ktown213.com");
      return false;    }
  }
// -->
</script>
